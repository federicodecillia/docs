---
title: "Upload a File"
api: "POST https://app.gptchatbot.it/api/v1/chatbot/{uuid}/data-source/upload"
...
"' https://app.gptchatbot.it/api/v1/chatbot/{uuid}/data-source/upload \
...
api_url = 'https://app.gptchatbot.it/api/v1/chatbot/{uuid}/data-source/upload'
