...
url = f'https://app.gptchatbot.it/api/v1/chatbot/{uuid}/sessions?start_timestamp={start_timestamp}&end_timestamp={end_timestamp}'
headers = {
...
const url = `https://app.gptchatbot.it/api/v1/chatbot/${uuid}/sessions?start_timestamp=${start_timestamp}&end_timestamp=${end_timestamp}`;
const headers = {
  Authorization: "Bearer <token>",
};
