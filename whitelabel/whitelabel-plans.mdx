...
| voice_credits_bonus        | int                 | Number of AI voice credits assigned to the user when the subscription is first purchased.                                                                                                          |
| voice_credits_replenish    | int                 | Number of AI voice credits replenished at the beginning of every month.                                                                                                                            |
| voice_enabled              | bool                | Whether AI voice feature is enabled.                                                                                                                                                               |